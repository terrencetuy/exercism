defmodule KitchenCalculator do
  ...
  def to_milliliter({:cup, volume}), do: {:milliliter, @milliliters_per_cup * volume}
  def to_milliliter({:fluid_ounce, volume}), do: {:milliliter, @milliliters_per_fluid_ounce * volume}
  def to_milliliter({:teaspoon, volume}), do: {:milliliter, @milliliters_per_teaspoon * volume}
  def to_milliliter({:tablespoon, volume}), do: {:milliliter, @milliliters_per_tablespoon * volume}
